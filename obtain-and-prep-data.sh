...
# and rename it "genome" (or make a Symbolic link).

# Here is what I did (making a symbolic link)
ln -s ~/scratch/chr-32-bioinformatics-elenacorrea/pre-indexed-chinook-genome/ genome
...
# Here is what I did (making a symbolic link)
ln -s ~/scratch/chr-32-bioinformatics-elenacorrea/fastqs-chr32-160-chinook-8-lanes/ fastqs
